 ...
 * from the server response package.
...
public final class ClientsInfo {
    ...
    /**
     * Method for getting the start date
     * so that other formatting may be applied.
     ...
     * the start date in a formatted manner with long month name.
    ...
    /**
     * Convenience method for getting
     * the start date in a formatted manner with short month name.
     * @return      the formatted date
     */
    ...
    /**
     * Method for getting the current game date
     * so that other formatting may be applied.
     * @return  [0] = day(1-31), [1] = month(0-11), [2] = year
     */
    ...
    /**
     * Convenience method for getting
     * the game date in a formatted manner with long month name.
     * @return      the formatted date
     */
    ...
    /**
     * Convenience method for getting
     * the game date in a formatted manner with short month name.
     * @return      the formatted date
     */
    ...
    /**
     * Method for finding out whether or not the server
    ...
    /**
     * Method for finding out whether or not the server
     * is running in dedicated mode or if it is participating
     * as a client.
