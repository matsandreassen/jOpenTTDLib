...
public final class JOTLQuerier implements Comparable<JOTLQuerier> {
	...
	private ServerResponseInfo serverResponseInfo;
	/** One of the objects that will contain gathered information */
	private ServerDetailedInfo serverDetailedInfo;
	...
	private DatagramPacket createNewGRFSPacket() {
		...
		//TODO: Bruk informasjonen lagret i ServerResponseInfo.
		return querypacket;
	}
	...
	private void recieve(byte[] data) throws IOException, SocketException {
		...
		switch (type) {
			case SERVER_RESPONSE:
				...
				this.serverResponseInfo = new ServerResponseInfo(data);
			...
			case SERVER_DETAIL_INFO:
				...
				this.serverDetailedInfo = new ServerDetailedInfo(data);
	 ...
	 * @return  the current {@link ServerResponseInfo} object or null if no info has been collected
	 */
	 ...
	 * @return  the current {@link ServerDetailedInfo} object or null if no info has been collected
	 */
