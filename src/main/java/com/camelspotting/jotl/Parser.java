...
public final class Parser {
    ...
    /**
     * Method to overcome Java's lack of unsigned bytes.
     * It's bit-magic. Haha!
    ...
    /**
     * Support method for converting 8 bytes to unsigned longs by
     * 'bit magic'.
    ...
    /**
     * Support method for converting 4 bytes to unsigned ints by
     * 'bit magic'.
     * @param B         the byte array
     * @param offset    the index of where to start
    ...
    /**
     * Support method for converting 2 bytes to unsigned ints by
     * 'bit magic'.
     * @param B         the byte array
     * @param offset    the index of where to start
     * @return          an array of ints
     ...
     * @return          the number.
     *
    static int parse16BitNumber(byte[] data, int offset) {
    return parse16BitNumber(data, offset, Endian.LITTLE);
    }*/
    /**
    ...
    /**
     * Method for parsing contents of offset byte array to offset {@link String}.
    ...
    /**
     * Support method for determining whether
     * a year is a leapyear.
    ...
    /**
     * This method checks if host is an IP-address via regex and parses it
     * or if not, does a DNS look up on it.
    ...
    /**
     * Conveninence method for parsing an version 6 IP-address.
     * NOTE: This method does not work since version 6 is not supported
     * by OpenTTD.
     * @param host      the IP to parse
     * @return          an {@link InetAddress}-object
     * @throws java.net.UnknownHostException
    ...
    /**
     * Method for getting a date converted to a string
     * with a short month.
    ...
    private enum ACCUM {
        ...
        /**
         * Method for getting to the number of days accumulated up to
         * this month.
         * @return      the value
         */
        public int getValue() {
